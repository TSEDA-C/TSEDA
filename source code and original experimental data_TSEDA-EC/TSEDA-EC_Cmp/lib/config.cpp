...
void ConfigParameter_TSEDA() {
    ...
    Parameter_TSEDA.theta2 = 0.10;
    Parameter_TSEDA.NumOfEliteOfPop = ceil(Parameter_TSEDA.NumOfChromPerPop * 0.02);
    Parameter_TSEDA.NumOfImproveOfPop = ceil(Parameter_TSEDA.NumOfChromPerPop * 0.06);
    Parameter_TSEDA.RunTimeRatioOfStg1 = 0.35;
}
