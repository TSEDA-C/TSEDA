...
void ConfigParameter_TSEDA() {
    Parameter_TSEDA.NumOfChromPerPop = Tasks.size() * 0.8;
    if (Parameter_TSEDA.NumOfChromPerPop % 2 == 1) {
        ++Parameter_TSEDA.NumOfChromPerPop;
    }
    Parameter_TSEDA.theta1 = 0.05;
    Parameter_TSEDA.theta2 = 0.2;
    Parameter_TSEDA.NumOfEliteOfPop =  ceil(Parameter_TSEDA.NumOfChromPerPop * 0.01);
    Parameter_TSEDA.NumOfImproveOfPop= ceil(Parameter_TSEDA.NumOfChromPerPop * 0.3);
    Parameter_TSEDA.RunTimeRatioOfStg1 = 0.65;
}
