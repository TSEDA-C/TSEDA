...
//            if (fabs(CurEC - CurEC1) > PrecisionValue )  cout << "EC: " << CurEC << "; EC1: "<< CurEC1 << endl;
...
//    chromosome temCh = ch;
//    DcdEvl_S(temCh);
//    CalculateEnergy1(temCh);
//    if (fabs(temCh.EnergyConsumption - ch.EnergyConsumption)> PrecisionValue) {
//        cout << "ch: " << ch.EnergyConsumption << "; temCh: "<< temCh.EnergyConsumption << endl;
//    }
...
double PrintIFBD_S(chromosome& ch) {
    chromosome orignalChrom = ch;
    chromosome NewChrom = ch;
    chromosome OldChrom;
    PrintChrom(orignalChrom);
    do {
        OldChrom = NewChrom;
        vector<int> ind(comConst.NumOfTsk);
        IndexSortByValueOnAscend(ind, OldChrom.EndTime);
...
void LBCA_S(chromosome& ch) {
    ...
    DcdEvl_S(ch);
//    if (ch.MakeSpan + PrecisionValue < OldCh.MakeSpan) cout << endl << "MS is Optimaized in LBCA_S";
    CalculateEnergy1(ch);
//    if (ch.EnergyConsumption + PrecisionValue < OldCh.EnergyConsumption) {
//        cout << endl << "LBCA_S is OK!";
//        PrintChrom(OldCh);
//        PrintChrom(ch);
//    }
//    chromosome chromAfterLd = ch;
    IFBD_S(ch);
//    if (ch.EnergyConsumption + PrecisionValue < chromAfterLd.EnergyConsumption && chromAfterLd.EnergyConsumption + PrecisionValue < OldCh.EnergyConsumption ) {
//        cout << endl << "LBCA_S and IFBD_S are OK!";
//        PrintChrom(OldCh);
//        PrintChrom(chromAfterLd);
//        PrintChrom(ch);
////        exit(2);
//    }
