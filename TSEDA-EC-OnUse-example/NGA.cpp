...
chromosome runNGA(string XmlFile, string RscAlcFile, double& SchTime, int& iteration){
    clock_t start=clock();
...
//            break;
//        }
        if (population[0].EnergyConsumption < 2205.95001) {
            SchTime = RunTime;
            break;
        }
...
//            GnrML_Evl_MEC_S(NextPopulation[n]);
        }
